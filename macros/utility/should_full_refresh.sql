...
{% macro default__should_full_refresh() %}
    ...
    {% set msg = "Full refresh logic should apply: " ~ is_full_refresh ~ " is_relation_exist: " ~ is_relation_exist ~ " is_table_materialisation: " ~ is_table_materialisation ~ " flags.FULL_REFRESH: " ~ flags.FULL_REFRESH %}
